...
import main.countryState.TradeDevelopment;
...
public class PruningStrategy implements  SuccessorsInterface{

    private final TradeDevelopment tradeDevelopment = new TradeDevelopment();
    @Override
    public List<State> execute(
            ...
            Map<Resource, Map<Resource, Integer>> manufacturingOutputManual) throws Exception {
    ...
    private void getTransferSuccessors(
        ...
        currentCountryStates
                .entrySet()
                .parallelStream()//.stream()//.parallelStream() for better performance//.parallelStream()
                    ...
                    originCountry
                            ...
                            .forEach(resourceEntry -> {
                                ...
                                while (amount <= maxAmount) {
                                    ...
                                    try {
                                        State newState = tradeDevelopment.takeOperation(
                                                currentState,
                                                newOperation,
    ...
    private void getTransformSuccessors(
        ...
        resourceList
                // Stream
                .parallelStream()//.stream()//.parallelStream() for better performance
